...
| `PERF_PLAN_MEDIUM_FINDINGS.md` | F7 assembly cache LRU + B3 worker idle backoff + B4 parallel translation | Active |
...
5. **MEDIUM batch** — `PERF_PLAN_MEDIUM_FINDINGS.md` (F7, B3, B4)
